...
object VIPScreen {
    ...
    fun build(player: Player): YamlConfiguration {
        return ScreenUI("vip").apply {
            ...
            if (player.hasPermission("vip") || player.hasPermission("svp") || player.hasPermission("mvp")) {
                addComponent(TextureComp("vip_cant_buy", "ui/common/button_normal_g.png")
                    .setText("&f&l已兑换")
